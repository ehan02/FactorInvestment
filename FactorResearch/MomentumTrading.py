...
data = {
    'AAPL': [150, 152, 155, 157, 160, 162, 164, 165, 170, 172],
    'GOOGL': [2725, 2710, 2730, 2750, 2770, 2790, 2780, 2760, 2750, 2775],
    'AMZN': [3100, 3120, 3140, 3130, 3150, 3170, 3190, 3200, 3210, 3230]
}
